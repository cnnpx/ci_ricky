        ...
        <div class="container-fluid">
            ...
            <section class="content">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio-group">
                                        <span class="item"><input type="radio" name="ReturnGoodTypeId" class="iCheckRadio" value="1" checked> Hoàn đơn bưu điện</span><br/>
                                        <span class="item"><input type="radio" name="ReturnGoodTypeId" class="iCheckRadio" value="2"> Hoàn đơn ngoại thành</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <ul class="list-inline pull-right" style="margin-right: 10px;">
                    ...
                    <input type="text" hidden="hidden" id="returnGoodId" value="0">
                    <input type="text" hidden="hidden" id="customerId" value="0">
                    <input type="text" hidden="hidden" id="transportStatusId" value="1">
