                        ...
                        <div class="box box-default padding15">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <?php $this->Mconstants->selectNumber(1, 100, 'DisplayOrder', $category['DisplayOrder'], true); ?>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $this->Mconstants->selectObject($listProductTypes, 'ProductTypeId', 'ProductTypeName', 'ProductTypeId', $category['ProductTypeId'], false, '', ' select2') ?>
                                </div>
                            </div>
                        </div>
                    </div>
