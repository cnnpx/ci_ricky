        ...
        <div class="container-fluid">
            <section class="content-header">
                ...
                <ul class="list-inline">
                    <li><a href="<?php echo base_url('import/add'); ?>" class="btn btn-primary">Tạo phiếu nhập kho</a></li>
            ...
            <section class="content">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs" id="ulFilter">
                        <li class="active"><a href="#tab_0" data-id="0" data-toggle="tab" aria-expanded="true">Tất cả phiếu nhập</a></li>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-header with-border">
                        ...
                        <select class="form-control input-sm select-action" id="selectAction" style="display: none;">
                            ...
                            <option value="change_status-0">Xóa nhập kho kho đã chọn</option>
                    ...
                    <div class="box-body table-responsive no-padding divTable">
                        <table class="table table-hover table-bordered">
                            ...
                            foreach($listImports as $i){ ?>
                                <tr id="trItem_<?php echo $i['ImportId']; ?>">
                                    <td><input type="checkbox" class="iCheckTable iCheckItem" value="<?php echo $i['ImportId']; ?>"></td>
                                    <td><a href="<?php echo base_url('import/edit/'.$i['ImportId']); ?>"><?php echo $i['ImportCode']; ?></a></td>
                                    <td><?php echo ddMMyyyy($i['CrDateTime'], 'd/m/Y H:i'); ?></td>
                                    <td><?php echo $this->Mconstants->getObjectValue($listStores, 'StoreId', $i['StoreId'], 'StoreName'); ?></td>
                                    <td><?php echo $this->Mconstants->getObjectValue($listSuppliers, 'SupplierId', $i['SupplierId'], 'SupplierName'); ?></td>
                                    <td><?php echo $i['DeliverName'].'<br>';?><?php echo $i['DeliverPhone']?></td>
                                    <td id="statusName_<?php echo $i['ImportId']; ?>"><span class="<?php echo $labelCss[$i['StatusId']]; ?>"><?php echo $status[$i['StatusId']]; ?></span></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
                    </div>
                    <input type="text" hidden="hidden" id="changeItemStatusUrl" value="<?php echo base_url('import/changeStatusBatch'); ?>">
                    <input type="text" hidden="hidden" id="itemTypeId" value="8">
