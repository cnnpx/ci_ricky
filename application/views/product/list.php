        ...
        <div class="container-fluid">
            <section class="content-header">
                ...
                <ul class="list-inline">
                    <li><a href="<?php echo base_url('product/add'); ?>" class="btn btn-default">Thêm sản phẩm mới</a></li>
                </ul>
            </section>
            <section class="content">
                ...
                <div class="box box-success">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            foreach($listProduct as $p){ ?>
                                <tr id="trItem_<?php echo $p['ProductId']; ?>">
                                    ...
                                    <td></td>
                                    <td> <?php echo $this->Mconstants->getObjectValue($listProductTypes, 'ProductTypeId', $p['ProductTypeId'], 'ProductTypeName'); ?></td>
                                    <td> <?php echo $this->Mconstants->getObjectValue($listSuppliers, 'SupplierId', $p['SupplierId'], 'SupplierName'); ?></td>
                    ...
                    <input type="text" hidden="hidden" id="itemTypeId" value="3">
