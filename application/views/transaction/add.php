        ...
        <div class="container-fluid">
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="customerName" disabled value="">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <?php $this->Mconstants->selectConstants('transactionTypes', 'TransactionTypeId'); ?>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="paidCost"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-4" id="divMoneyPhone" style="display: none;">
                        <div class="form-group">
                            ...
                            <?php $this->Mconstants->selectObject($listMoneyPhones, 'MoneyPhoneId', 'MoneyPhoneName', 'MoneyPhoneId', 0, true, '-Chọn số máy-'); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <ul class="list-inline pull-right" style="margin-right: 10px;">
                    ...
                    <input type="text" hidden="hidden" id="transactionStatusId" value="1">
                </ul>
                <?php echo form_close(); ?>
            </section>
        </div>
