            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="PhoneNumber" id="phoneNumber" class="form-control" value="<?php echo $user['PhoneNumber']; ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="UserName" id="userName" class="form-control hmdrequired" value="<?php echo $user['UserName']; ?>" data-field="Tên đăng nhập">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
