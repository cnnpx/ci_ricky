        ...
        <div class="container-fluid">
            <section class="content-header">
                ...
                <ul class="list-inline">
                    <li><a href="<?php echo base_url('storecirculation/add'); ?>" class="btn btn-primary">Thêm mới</a></li>
                </ul>
            </section>
            <section class="content">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs" id="ulFilter">
                        <li class="active"><a href="#tab_0" data-id="0" data-toggle="tab" aria-expanded="true">Tất cả </a></li>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-header with-border">
                        ...
                        <select class="form-control input-sm select-action" id="selectAction" style="display: none;">
                            ...
                            <option value="change_status-0">Xóa Lưu chuyển kho đã chọn</option>
                    ...
                    <div class="box-body table-responsive no-padding divTable">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <th>Mã lưu chuyển</th>
                                <th>Cơ sở xuất hàng</th>
                                <th>Cơ sở nhận</th>
                                <th>Trạng thái đơn hàng</th>
                                <th>Trạng thái duyệt</th>
                            </tr>
                            </thead>
                            <tbody id="tbodyStoreCirculation">
                            <?php $labelCss = $this->Mconstants->labelCss;
                            $status = $this->Mconstants->status;
                            foreach($listStoreCirculations as $sc){ ?>
                                <tr id="trItem_<?php echo $sc['StoreCirculationId']; ?>">
                                    <td><input type="checkbox" class="iCheckTable iCheckItem" value="<?php echo $sc['StoreCirculationId']; ?>"></td>
                                    <td><a href="<?php echo base_url('storecirculation/edit/'.$sc['StoreCirculationId']); ?>"><?php echo $sc['StoreCirculationCode']; ?></a></td>
                                    <td><?php echo $this->Mconstants->getObjectValue($listStores, 'StoreId', $sc['StoreSourceId'], 'StoreName'); ?></td>
                                    <td><?php echo $this->Mconstants->getObjectValue($listStores, 'StoreId', $sc['StoreDestinationId'], 'StoreName'); ?></td>
                                    <td><span class="<?php echo $labelCss[$sc['OrderStatusId']]; ?>"><?php echo $orderStatus[$sc['OrderStatusId']]; ?></span></td>
                                    <td><span class="<?php echo $labelCss[$sc['StatusId']]; ?>"><?php echo $status[$sc['StatusId']]; ?></span></td>
                                </tr>
                            <?php } ?>
                            </tbody>
                        </table>
                    </div>
                    <input type="text" hidden="hidden" id="changeItemStatusUrl" value="<?php echo base_url('api/storecirculation/changeStatusBatch'); ?>">
                    <input type="text" hidden="hidden" id="itemTypeId" value="7">
