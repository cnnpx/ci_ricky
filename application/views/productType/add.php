        ...
        <section class="content" style="background: #FFFFFF;margin-top: 10px;">
            ...
            <div class="row col-sm-offset-1">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="ProductTypeName" id="productTypeName" class="form-control hmdrequired" value="" data-field="Tên mảng kinh doanh">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2">Cổ phần</label>
                    <div class="col-sm-8">
                        <?php $this->Mconstants->selectConstants('isShare', 'IsShare'); ?>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control hmdrequired datepicker" name="ActiveDate " id="activeDate"value="" autocomplete="off" data-field="Ngày hoạt động">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="text" id="productTypeId" hidden="hidden" value="0">
                        <input type="text" id="productTypeEditUrl" hidden="hidden" value="<?php echo base_url('productType'); ?>">
