    ...
    var n = {
      ...
      , t = function() {
        ...
        function R(a, b) {
            ...
            return Fa || c !== b.elements.modal || !0 !== b.get("closableByDimmer") || E(b),
            Fa = !1,
            !1
        }
        function S(a, b) {
        ...
        function U(a) {
            ...
            var b = p[p.length - 1]
              , c = a.keyCode;
            return 0 === b.__internal.buttons.length && c === n.ESC && !0 === b.get("closable") ? (E(b),
        ...
        function W(a, b) {
            if (b)
                ...
                void 0 !== d && null !== d || 0 !== a.__internal.buttons.length || (d = a.elements.reset[0]),
                d && d.focus && (d.focus(),
        ...
        function _(a, b) {
            ...
            b.style.top = Na ? Math.min(Ma.maxTop, Math.max(Ma.minTop, d)) + "px" : Math.max(Ma.minTop, d) + "px"
        }
        function aa(a, c) {
        ...
        function fa(a, b, c) {
            ...
            do {
                f += e.offsetLeft,
                g += e.offsetTop
            } while (e = e.offsetParent);var h, i;
            !0 === c ? (h = a.pageX,
        ...
        return {
            ...
            setting: function(a, b) {
                ...
                if ("get" === d.op)
                    return d.found ? d.value : void 0 !== this.settings ? D(this, this.settings, this.settingUpdated || function() {}
                    , a, b).value : void 0;
                if ("set" === d.op) {
                    if (d.items.length > 0)
            ...
            close: function() {
                return this.__internal.isOpen && !1 !== l("onclosing", this) && (na(this),
        ...
        function i(d, h) {
            ...
            return o({
                ...
                dismiss: function(a) {
                    ...
                    "function" == typeof this.ondismiss && !1 === this.ondismiss.call(this) || (r(this.element, "click", this.__internal.clickHandler),
                    void 0 !== this.element && this.element.parentNode === l && (this.__internal.transitionTimeout = setTimeout(this.__internal.transitionEndHandler, s.supported ? 1e3 : 100),
                ...
                delay: function(a) {
                    if (p(this),
                    this.__internal.delay = void 0 === a || isNaN(+a) ? u.__internal.delay : +a,
