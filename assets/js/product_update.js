                        ...
                        if (data.TypeId == 1) {
                            if(data.ProductChild.length > 0) {
                                for (var i = 0; i < data.ProductChild.length; i++) {
                                    ...
                                    html += '<td><input type="checkbox" class="iCheck iCheckVAT"></td>';
                                    html += '<td><input class="form-control guaranteeMonth" value="' + data.ProductChild[i].GuaranteeMonth + '"></td>';
                                ...
                                html += '<td><input type="checkbox" class="iCheck iCheckVAT"></td>';
                                html += '<td><input class="form-control guaranteeMonth" value="' + data.Product.GuaranteeMonth + '"></td>';
                                html += '<td><a href="javascript:void(0)" class="link_delete"><i class="fa fa-times" title="Xóa"></i></a></td></tr>';
                            }
                        }
                        else {
